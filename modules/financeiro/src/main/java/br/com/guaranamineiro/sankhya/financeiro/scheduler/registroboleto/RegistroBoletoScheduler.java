package br.com.guaranamineiro.sankhya.financeiro.scheduler.registroboleto;
...
public class RegistroBoletoScheduler implements ScheduledAction {
   ...
   public void onTime(ScheduledActionContext ctx) {
      ...
      try {
         ...
         if (!permitido) {
            System.out.println(String.format("%s porém está no %s, não é permitido.", 
